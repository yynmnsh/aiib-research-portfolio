...
with tab1:
    ...
    fig_area.add_vline(x=2024, line_dash='dash', line_color='white', opacity=.4,
        annotation_text='Historical | Projected', annotation_position='bottom right')
...
with tab2:
    ...
    fig_prov.update_layout(paper_bgcolor='#06080f',height=450,margin=dict(t=10,b=10,l=10,r=10),
        coloraxis_colorbar=dict(title=dict(text='Carbon Int.',font=dict(color='#e2e8f0')),tickfont=dict(color='#94a3b8')),
